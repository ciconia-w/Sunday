...
export default defineComponent({
    ...
    setup(props) {
        ...
        const shouldUsePlainTextStreaming = computed(() => props.showLoading && !props.isUser);
        ...
        watch(() => [props.content, props.showLoading], () => {
            if (shouldUsePlainTextStreaming.value) {
                return;
            }
            nextTick(() => {
    ...
    render() {
        return (
            <span
                class={["markdown-content", this.shouldUsePlainTextStreaming && "markdown-content--streaming"]}
                ref="markdownRef"
                innerHTML={this.renderMarkdown}
                v-html={this.renderMarkdown}
            />
        );
    },
});
