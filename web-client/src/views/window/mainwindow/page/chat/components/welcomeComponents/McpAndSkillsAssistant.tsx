...
export default defineComponent({
    ...
    setup() {
        ...
        const mcpButtonTitleText = backendStore.translate("MCP Services");
        const mcpButtonDescText = backendStore.translate("Configure available MCP services");
        const skillsButtonTitleText = backendStore.translate("Skills");
        const skillsButtonDescText = backendStore.translate("Manage local skills and toggles");
