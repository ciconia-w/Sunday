...
export default defineComponent({
    ...
    setup(props) {
        ...
        const options = computed<Array<{ key: OptionType; label: string }>>(() => [
            ...
            {
                key: "reject",
                label: backendStore.translate("Reject & Revise - Tell Sunday what to change"),
            },
        ]);
        ...
        const handleKeyDown = (e: KeyboardEvent) => {
            ...
            const isInsideBashApprove = !!target.closest?.(".bash-approve");
            ...
            if (e.key === "ArrowDown") {
                ...
                if (selectedIndex.value === "reject") rejectInputRef.value?.focus();
            } else if (e.key === "Enter" && isInsideBashApprove) {
                e.preventDefault();
                e.stopPropagation();
                handleSubmit();
