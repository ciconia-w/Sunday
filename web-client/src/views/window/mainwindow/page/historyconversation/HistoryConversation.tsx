...
export default defineComponent({
    ...
    setup() {
        ...
        // 翻译文案
        const historyText = computed(() => backendStore.translate("Conversations"));
        const searchText = computed(() => backendStore.translate("Search Conversations"));
        const deleteText = computed(() => backendStore.translate("Delete"));
        const batchManageText = computed(() => backendStore.translate("Select Multiple"));
        const searchPlaceholderText = computed(() =>
            backendStore.translate("Search conversation titles and replies…"),
        );
        const noHistoryText = computed(() =>
            searchKeyword.value
                ? backendStore.translate("No matching conversations found.")
                : backendStore.translate("No conversations yet"),
        );
        ...
        const handleDeleteConversation = (conversationId: string) => {
            ...
            void notifyStore
                .showDialog({
                    ...
                    content: `${backendStore.translate("This will remove the conversation and related local records.")}`,
                    buttons: [
        ...
        const handleBatchDelete = (selectedIds: string[]) => {
            ...
            void notifyStore
                .showDialog({
                    title: backendStore.translate("Delete selected conversations?"),
                    content: `${backendStore.translate("This will permanently remove the selected local conversation records.")}`,
                    buttons: [
                        { key: "cancel", text: backendStore.translate("Cancel"), type: "default" },
                        { key: "confirm", text: backendStore.translate("Confirm Delete"), type: "danger" },
                    ],
